    ...
    def render_to_response(self):
        return render_modal_workflow(
            ...
            json_data={
                ...
                "error_message": _(
                    "Report this error to your website administrator with the following information:",  # noqa: E501
                ),
...
def embed_video_chosen(request, embed_video_id):
    ...
    return render_modal_workflow(
        ...
        None,
        json_data={
            "step": "embed_video_chosen",
            "result": get_embed_video_result_data(embed_video),
        },
    )
...
def chooser_upload(request):
    ...
    upload_form_html = render_to_string(
        "wagtail_embed_videos/chooser/upload_form.html",
        {
            "form": form,
        },
        request,
