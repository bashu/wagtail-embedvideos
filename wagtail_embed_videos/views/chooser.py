...
def chooser(request):
    ...
    if request.user.has_perm('wagtailembed_videos.add_embed_video'):
    ...
    return render_modal_workflow(request, 'wagtail_embed_videos/chooser/chooser.html', 'wagtail_embed_videos/chooser/chooser.js', {
        'embed_videos': embed_videos,
